...
namespace DXMNCGUI_SNOW.Controllers
{
    ...
    public class SqlDBSession
    {
        ...
        public static SqlDBSession Create(SqlDBSetting dbSetting)
        {
        ...
        public static SqlDBSession CreatesqlDBSession(SqlDBSetting dbSetting)
        {
            return SqlDBSession.Create(dbSetting);
        }

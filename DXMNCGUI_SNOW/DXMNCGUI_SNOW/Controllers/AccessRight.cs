...
namespace DXMNCGUI_SNOW.Controllers
{
    ...
    public class AccesRight
    {
        ...
        public static AccesRight Create(SqlDBSetting dbSetting, string userID)
        {
            ...
            accessRight.myDBSetting = dbSetting;
    ...
    public class AccessRightSQL : AccesRight
    {
        ...
        public override bool IsAccessibleByUserID(string userID, string cmdID)
        {
            ...
            {
                DXMNCGUI_SNOW.Logic.ExceptionUtility.LogException(ex, "HttpCall in AccesRright.cs");
                flag = false;
            }
            return flag;
        }
        ...
        public override bool IsAccessible(string cmdID)
        {
            ...
            else
            {
                lock (this.myLock)
                {
                    ...
                    {
                        SqlConnection local_0 = new SqlConnection(this.myDBSetting.ConnectionString);
                        try
                        {
                            local_0.Open();
                            if (this.myCacheUserTable == null)

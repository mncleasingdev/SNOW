<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="FormRequestTicketEntry.aspx.cs" Inherits="DXMNCGUI_SNOW.Transaction.TicketTrans.Request.FormRequestTicketEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function cplMain_EndCallback(s, e) {            
            ...
            {
                case "CATEGORY":
                    var varMainLayout = MainLayout.GetItemByName("lgUserAdmin");
        ...
        function OncbCategoryChanged(cbCategory)
        {
            if (cbCategory.GetText() != "")
            {
                ...
                else
                {
                    ...
                    cplMain.PerformCallback("CATEGORY;" + cbCategory.GetValue().toString());
                }                
            }
        }
    ...
    <dx:ASPxFormLayout ID="MainLayout" ClientInstanceName="MainLayout" runat="server" Theme="BlackGlass">
        <SettingsAdaptivity AdaptivityMode="SingleColumnWindowLimit" SwitchToSingleColumnAtWindowInnerWidth="800"/>
        <Items>
            <dx:LayoutGroup Name="lgMain" GroupBoxDecoration="HeadingLine" Caption="Ticket Entry" ColCount="1">
                <GroupBoxStyle>
                    <Caption ForeColor="SlateGray" Font-Size="Larger" Font-Bold="true"></Caption>
                </GroupBoxStyle>
                <Items>
                    <dx:LayoutGroup Name="lgTicketDetail" GroupBoxDecoration="Default" Width="100%" Caption="Ticket Detail" ShowCaption="True">
                        <Items>
                            ...
                            <dx:EmptyLayoutItem Width="75%"></dx:EmptyLayoutItem>
                            <dx:LayoutGroup Name="lgUserAdmin" Caption="User Administration Detail" GroupBoxDecoration="None" ColCount="2" Width="50%" ClientVisible="false" ParentContainerStyle-Paddings-PaddingLeft="100px">
                                <Items>
                                    <dx:LayoutItem Caption="Email" Name="liEmail" Visible="true">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxCheckBox runat="server" ID="chkEmail" Theme="MetropolisBlue"></dx:ASPxCheckBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Caption="PC Login">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxCheckBox runat="server" ID="chkPcLogin" Theme="MetropolisBlue"></dx:ASPxCheckBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Caption="SMILE">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxCheckBox runat="server" ID="chkSMILE" Theme="MetropolisBlue"></dx:ASPxCheckBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Caption="Filezilla">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxCheckBox runat="server" ID="chkFilezilla" Theme="MetropolisBlue"></dx:ASPxCheckBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                    <dx:LayoutItem Caption="PIN Telepon">
                                        <LayoutItemNestedControlCollection>
                                            <dx:LayoutItemNestedControlContainer>
                                                <dx:ASPxCheckBox runat="server" ID="chkPin" Theme="MetropolisBlue"></dx:ASPxCheckBox>
                                            </dx:LayoutItemNestedControlContainer>
                                        </LayoutItemNestedControlCollection>
                                    </dx:LayoutItem>
                                </Items>
                            ...
                            <dx:LayoutItem Caption="Description" Height="100px" Width="41%">
                                <LayoutItemNestedControlCollection>
                            ...
                            <dx:EmptyLayoutItem Width="59%"></dx:EmptyLayoutItem> 
                            <dx:LayoutItem Caption="Purpose/Benefit" Height="100px" Width="41%">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server">
                                        <dx:ASPxMemo ID="mmDescription2" TabIndex="3" runat="server" Height="100%" Theme="MetropolisBlue">
                                            <ValidationSettings Display="Dynamic" SetFocusOnError="True" ValidationGroup="ValidationSave">
                                                <RequiredField ErrorText="* Value can't be empty." IsRequired="True" />
                                            </ValidationSettings>
                                        </dx:ASPxMemo>
                            ...
                            <dx:EmptyLayoutItem Width="50%"></dx:EmptyLayoutItem>
                            <dx:LayoutItem Name="LayoutItemReason" ShowCaption="True" Caption="IT Remarks"  Height="100px" Width="41%">
                                <LayoutItemNestedControlCollection>
            ...
            <dx:LayoutGroup Name="lgButtonAction" GroupBoxDecoration="None" ShowCaption="False" ColCount="9" Width="100%">
                <Items>

...
{
    public class TicketNewEntity
    {
        private TicketDB myTicketNewcommand;
        ...
        public TicketDB Ticketcommand
        {
            get
            {
                return this.myTicketNewcommand;
            }
        }
        ...
        public TicketNewEntity(TicketDB aTicket, DataSet ds, TicketAction action)
        {
            myTicketNewcommand = aTicket;
            myDataSet = ds;
        ...
        public DataTable LoadDocNoFormatTable()
        {
            ...
            mytable = myTicketNewcommand.DBSetting.GetDataTable("select * from DocNoFormat where DOCTYPE='IN'", false);
            return mytable;
        }
        public DataTable LoadCategoryTable()
        {
            DataTable mytable = new DataTable();
            mytable = myTicketNewcommand.DBSetting.GetDataTable("select Category from [dbo].[Category] where DocType='IN'", false);
            return mytable;
        }
        public DataTable LoadCategorySubTable(string category)
        {
            ...
            mytable = myTicketNewcommand.DBSetting.GetDataTable(strQuery, false, category);
            return mytable;
        }
        ...
        public void Save(string userID, string strDocName, SaveAction saveaction, DataTable dtCopyApp)
        {
            ...
            }
            {
                ...
                if (flag)
                {
                    ...
                    this.myRow["LastModifiedTime"] = (object)this.myTicketNewcommand.DBSetting.GetServerTime();
                    if (this.myRow["CreatedUserID"].ToString().Length == 0)
                        this.myRow["CreatedUserID"] = this.myRow["LastModifiedUser"];
                    this.myRow.EndEdit();
                    myTicketNewcommand.SaveEntity(this, strDocName, saveaction, dtCopyApp);
                }
